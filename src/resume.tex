...
{2023 -- Now } {Sr. Staff Engineer}{Rosnet}{Parkville, MO}{}{
		\begin{itemize}
			\item
				...
				deployemnts, containerization, automated testing, and observability.
			\item
...
{2021 -- 2023} {Tech Lead}{Rosnet}{Parkville, MO}{}{
		\begin{itemize}
			\item
				...
				multiple features using .NET, React, RabbitMQ, \& Elasticsearch.
			\item
				Addressed one of the company's biggest scalability issues using
				RabbitMQ.
			\item
