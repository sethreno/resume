...
{2023 -- Now } {Sr. Staff Engineer}{Rosnet}{Parkville, MO}{}{
		\begin{itemize}
			\item
				...
				observability.
			\item
				Reviewed and helped improve designs for multiple projects.
			\item
...
{2012 -- 2020} {Sr. Software Engineer}{Rosnet}{Parkville, MO}{}{
	...
	\cventry
{2020 -- 2021} {Consultant}{ECS Geothermal}{}{}{
		\begin{itemize}
			\item 
...
{2009 -- Now } {Lead Maintainer}{Schema Zen}{github.com/sethreno/schemazen}{}{
		\begin{itemize}
			\item 
				Implemented a tool to dump and restore SQL Server schema to text
