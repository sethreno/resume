...
{2025 -- Now} {Sr. DevOps Engineer IDR-TA}{Index Analytics}{Baltimore, MD}{Remote}{
		\begin{itemize}
			\item
				Implemented features, performed code reviews, and provided
				production support for the IDR-TA Rules Engine. It provides
				analysts with AI insights and workflow tools to help them
				determine dispute eligibility quickly and accurately. It has a
				microservices architecture using Python, Java, and Postgres for
				back end services and Angular for the front end.
			\item
			...
			\item
				Identified the need and implemented automated tests that
				reduced regressions on core components.
			\item
				Helped design and implement AI chatbot component and its data
				pipeline.
			\item
				Implemented monitoring and alerting using CloudWatch.
			\item
				Changed database connections to use IAM authentication and
