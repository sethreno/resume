...
\linebreak
	...
	\cventry
{2001 -- 2006}{Sr. System Administrator \& Programmer Analyst}{Shook, Hardy \& Bacon / Cameron Insurance}{Kansas City, MO}{}{
		\begin{itemize}
			\item
				Built automation tools, a hardware tracking app, a .NET policy printing
				system (leveraging legacy COBOL parsing), and a low-bandwidth image
				upload app for insurance adjusters.
		\end{itemize}
}
\linebreak
